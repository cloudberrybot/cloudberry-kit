...
export default function DarkModeToggle() {
  ...
  function ToggleDarkMode() {
    return darkMode ? <LightModeButton /> : <DarkModeButton />;
  }
  ...
  return (
    ...
    >
      <div
        className="max-w-xs bg-white border rounded-full shadow-lg dark:bg-gray-800 dark:border-gray-700 hover:bg-blue-600 hover:stroke-white dark:hover:bg-yellow-500 dark:hover:fill-black"
        role="alert"
      >
